    ...
    <div class="col-md-4 col-xl-3">
      <div class="card mb-3">
        ...
        <div class="card-body text-center">
          <img src="<?=base_url('img/avatars/'.session()->donnee_utilisateur['pp_url'])?>" alt="<?=$nom_utilisateur?>" class="img-fluid rounded-circle mb-2" width="128" height="128" />
          <h5 class="card-title mb-0"><?=$nom_utilisateur?></h5>
          <div class="text-muted mb-2"><?=session()->donnee_utilisateur['profil']?></div>
        </div>
        <hr class="my-0" />
        <div class="card-body">
