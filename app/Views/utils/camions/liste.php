        ...
        <?php foreach ($liste as $ligne) : ?>
          ...
          <tr class=" align-items-center">
            ...
            <td class="d-flex gap-3 ">
              <a class=" flex-grow-0 px-0 btn" href="<?= base_url('index.php/' . session()->root . '/camions/modifier/' . $ligne['immatriculation']) ?>" role="button" title="Modifier les informations"><i class="align-middle" data-feather="edit"></i></a>
              <a class=" flex-grow-0 px-0 btn" href="<?= base_url('index.php/' . session()->root . '/camions/dossier/' . $ligne['immatriculation']) ?>" role="button" title="Voir le dossier"><i class="align-middle" data-feather="folder"></i></a>
