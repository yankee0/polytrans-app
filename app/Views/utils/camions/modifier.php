  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="row" action="<?= base_url(session()->root . '/camions/modifier') ?>" method="post">
        ...
        <div class="mb-3 col-sm-6 col-lg-3">
          <button type="submit" name="immatriculation_n" value="<?=$camion['immatriculation']?>" class="btn btn-primary d-flex justify-content-center align-items-center gap-2">
