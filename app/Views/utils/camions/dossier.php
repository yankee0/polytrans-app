...
<h1 class="h3 mb-3"><strong>Dossier</strong> <?= $camion['immatriculation'] ?></h1>
  ...
  <div class="col-sm">
    <div class="card flex-grow-1">
      <div class="card-body">
        <div class="row">
          <div class="col mt-0">
            <h5 class="card-title">Visite technique</h5>
          </div>
        ...
        <h4 class="mt-1 mb-3">
          <div class="mb-2">Début: <span class="text-primary"><?= (empty($camion['vt_debut']) ? 'Non défini' : $camion['vt_debut']) ?></span></div>
          <div>Fin: <span class="text-primary"><?= (empty($camion['vt_fin']) ? 'Non défini' : $camion['vt_fin']) ?></span></div>
        </h4>
        <div class="d-flex justify-content-end">
          <button class=" btn btn-primary btn-sm">Changer</button>
        </div>
      </div>
    </div>
  </div>
  <div class="col-sm">
    <div class="card flex-grow-1">
      <div class="card-body">
        ...
        <h4 class="mt-1 mb-3">
          <div class="mb-2">Début: <span class="text-primary"><?= (empty($camion['as_debut']) ? 'Non défini' : $camion['as_debut']) ?></span></div>
