            ...
            <ul class="navbar-nav navbar-align">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  ...
                  <a class="dropdown-item" href="<?= base_url(session()->root . '/mon-profil/') . session()->donnee_utilisateur['id'] ?>"><i class="align-middle me-1" data-feather="settings"></i> Mon profil </a>
          ...
          <div class="container-fluid">
            <div class="row text-muted">
              <div class="col-6 text-start">
                <p class="mb-0">
                  <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>POLY-TRANS APP</strong></a> - <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>by POLY-TRANS DEV TEAM 🤓</strong></a>
                </p>
              </div>
              <div class="col-6 text-end">
                <ul class="list-inline">
                  ...
                  <li class="list-inline-item">
                    <a class="text-muted" href="https://adminkit.io/" target="_blank">Polytique de confidentialités</a>
                  </li>
                </ul>
              </div>
            </div>
